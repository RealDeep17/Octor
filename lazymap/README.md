...
The main purpose of LazyMap at [Octor](https://github.com/webtor-io/octor) was to reduce requests between services by introducing intermediate caching-layer.
