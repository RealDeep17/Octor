...
const BADGE_CONFIG = {
    idle: {
        classes: 'badge badge-sm bg-base-200/50 border-o-line/30 text-o-muted gap-1.5 px-3 py-2',
    ...
    caching: {
        classes: 'badge badge-sm bg-o-primary/10 border-o-primary/30 text-o-primary gap-1.5 px-3 py-2',
    ...
    vaulting: {
        classes: 'badge badge-sm bg-o-primary/10 border-o-primary/30 text-o-accent gap-1.5 px-3 py-2',
...
function renderLoading() {
    return '<div class="badge badge-sm bg-base-200/50 border-o-line/30 text-o-muted gap-1.5 px-3 py-2"><span class="loading loading-dots loading-xs"></span></div>';
}
