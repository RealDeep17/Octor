...
// systemPrompt is the instruction block Gemini sees at the start of every
...
// It avoids tool_use entirely and asks Gemini for plain-text
...
// no JSON-schema enforcement on the AI side — Gemini is free to add
...
// history here, refine would only know "Gemini's previous suggestions",
...
// users don't pay tokens for a placeholder line — Gemini already knows from
...
// anyRecentTitle picks a title string Gemini can reference in the history-
